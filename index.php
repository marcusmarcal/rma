...
<option value="pend_tec">Pendente T�cnica</option>
...
<th><a href="?ordem=status2"><?php if($ordem == status2){ ?><font color=red><?php } ?>Pend�ncia</th>
...
switch ($status) {
   case "fim":
       ...
       break;
   case "pend_tec":
       $status = "<font color=\"red\"><b>T�cnica";
       break;
   case "pend_adm":
...
switch ($status2) {
   case 0:
       $fase = "<font color=\"red\"><b>Diagn�stico";
       break;
   case 1:
       $fase = "<font color=\"black\"><b>Or�amento";
       break;
   case 2:
       $fase = "<font color=\"blue\"><b>Aprova��o";
       break;
   case 3:
